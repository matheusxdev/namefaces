...
**npm:** [namefaces@0.7.0](https://www.npmjs.com/package/namefaces) · **Guia completo:** [docs/USO.md](./docs/USO.md)
...
## Nomes com rosto próprio (v0.7.0)

**Primeiros nomes:** 400 rostos (ex.: ana, maria, miguel, sabrina, pietro…)
...
```html
<script type="module">
  import { getAvatarDataUri } from 'https://cdn.jsdelivr.net/npm/namefaces@0.7.0/+esm'
